...
const API = {
  ...
  TakeStoreByUserLogin: "/TakeStoreByUserLogin",
  PostAllFoodListByStoreId: "/PostAllFoodListByStoreId",
  TakeStoreByCuisineUserLogin: "/TakeStoreByCuisineUserLogin",
};

const TakeAllStore = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy("post", ServiceEndPoint + API.TakeAllStore, request, true);
...
const CreateNewStore = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy("post", ServiceEndPoint + API.CreateNewStore, request, true);
    if (response.data.Success) {
...
const UpdateNewStore = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy("post", ServiceEndPoint + API.UpdateNewStore, request, true);
    if (response.data.Success) {
      result.success = true;
    }
  } catch (e) {
...
const TakeStoreByCuisineId = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy("post", ServiceEndPoint + API.TakeStoreByCuisineId, request, true);
    if (response.data.Success) {
      result.success = true;
      result.data = response.data.Data;
      result.dataCount = response.data.DataCount;
...
const PostAllFoodListByStoreId = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy(
      "post",
      ServiceEndPoint + API.PostAllFoodListByStoreId,
      request,
      true
    );
    if (response.data.Success) {
...
const TakeStoreByUserLogin = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy("post", ServiceEndPoint + API.TakeStoreByUserLogin, request, true);
    if (response.data.Success) {
      result.success = true;
      result.data = response.data.Data;
      result.dataCount = response.data.DataCount;
...
const TakeStoreByCuisineUserLogin = async (request) => {
  let result = new BaseResponse(false, "", null);
  try {
    let response = await Proxy(
      "post",
      ServiceEndPoint + API.TakeStoreByCuisineUserLogin,
      request,
      true
    );
    if (response.data.Success) {
...
export {
  ...
  TakeStoreByUserLogin,
  PostAllFoodListByStoreId,
  TakeStoreByCuisineUserLogin,
};
