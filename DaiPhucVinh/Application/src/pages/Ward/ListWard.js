...
export default function ListProvince() {
  ...
  async function onViewAppearing() {
    ...
    let responseWard = await TakeAllWard(filter);
    if (responseWard.success) {
      setData(responseWard.data);
      console.log(data);
  ...
  return (
    <>
      <Breadcrumb title="Danh sách thị xã" sources={breadcrumbSources} />
                                ...
                                onClick={() => {
                                  Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                      DeleteWard(i.WardId).then((response) => {
                                        if (response.success) {
                                          Swal.fire(
                                            "Hoàn thành!",
