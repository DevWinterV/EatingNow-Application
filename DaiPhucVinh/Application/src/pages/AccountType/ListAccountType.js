...
export default function ListProvince() {
  ...
  const breadcrumbSources = [
    {
      name: "Danh sách loại tài khoản",
      href: "#",
    },
    {
      name: "Danh sách",
  ...
  async function onViewAppearing() {
    setLoading(true);
    let response = await TakeAllAccountType(filter);
    if (response.success) {
  ...
  return (
    <>
      <Breadcrumb
        title="Danh sách loại tài khoản"
