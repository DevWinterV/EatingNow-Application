...
export default function ListProvince() {
  ...
  async function onViewAppearing() {
    setLoading(true);
    let response = await TakeAllProvince(filter);
    if (response.success) {
  ...
  return (
    <>
      <Breadcrumb title="Danh sách tỉnh thành" sources={breadcrumbSources} />
            ...
            <Table className="table table-striped">
              <Thead className="table-light">
                <Tr>
                  ...
                  <Th className="align-middle">Tên tỉnh thành</Th>
                          ...
                          <Td>
                            <div className="d-flex gap-3">
                              <div
                                ...
                                onClick={() => {
                                  history("/province/edit/" + i.ProvinceId, {
                                    state: { data: i },
                                  });
                                }}
                              >
                                ...
                                onClick={() => {
                                  Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                      DeleteProvince(i.ProvinceId).then(
                                        (response) => {
                                          if (response.success) {
                                            Swal.fire(
                                              "Hoàn thành!",
